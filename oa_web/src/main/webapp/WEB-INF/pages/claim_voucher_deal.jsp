...
<%@page import="com.lj.oa.global.Content" %>
                ...
                <div class="panel-body pn">
                    <table id="message-table" class="table admin-form theme-warning tc-checkbox-1">
                        ...
                        <tr class="message-unread">
                            ...
                            <td>
                                <c:if test="${cv.status==Content.CLAIMVOUCHER_BACK || cv.status==Content.CLAIMVOUCHER_CREATED}">
                                   <a href="/claim_voucher/to_update?id=${cv.id}">修改</a>
                                   <a href="/claim_voucher/submit?id=${cv.id}">提交</a>
                                </c:if>
                                <c:if test="${cv.status==Content.CLAIMVOUCHER_RECHECK || cv.status==Content.CLAIMVOUCHER_SUBMIT}">
